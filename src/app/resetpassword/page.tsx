        ...
        >
          <div className={`mx-auto w-full max-w-lg bg-gray-100 rounded-xl p-10 border border-black/10`}>
            ...
            <div className="w-full relative">
                        <label className='block mb-1 pl-1' htmlFor=''>Old Password: </label>
            ...
            <button className='px-4 py-2 rounded-sm mt-3 bg-blue-600 text-white disabled:bg-gray-400' onClick={onReset}
